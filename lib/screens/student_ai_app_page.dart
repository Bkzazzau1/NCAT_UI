...
class StudentAIAppPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final features = [
      (
        'AI Handbook',
        'Ask questions from NCAT-approved rules, policies and student handbook.',
        Icons.menu_book_rounded,
        'Source-based'
      ),
      (
        'Logbook Assistant',
        'Fill flight, simulator and workshop logbooks with AI guidance.',
        Icons.edit_note_rounded,
        'Instructor approval'
      ),
      (
        'Academic Assistant',
        'Explain topics, summarize notes, generate revision questions and study plans.',
        Icons.psychology_rounded,
        'Personalized'
      ),
      (
        'My Progress',
        'Track attendance, training hours, missing files, clearance and academic risk.',
      ...
      child: Column(
        children: [
          const SectionHeader(
            ...
            subtitle:
                'A student-facing app for approved policy answers, logbook filling, training support and academic help.',
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              final content = [
                const Expanded(child: _HandbookDemo()),
                const SizedBox(width: 14),
                const Expanded(child: _LogbookDemo()),
              ];
              if (isNarrow) {
    ...
    return const GlassCard(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12),
          StatusChip('Pending Instructor Approval'),
        ],
      ),
    );
  }
